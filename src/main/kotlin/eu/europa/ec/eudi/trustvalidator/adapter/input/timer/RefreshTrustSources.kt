 ...
 */
package eu.europa.ec.eudi.trustvalidator.adapter.input.timer

import eu.europa.ec.eudi.trustvalidator.adapter.out.cert.TrustSources
import eu.europa.ec.eudi.trustvalidator.adapter.out.utils.getOrThrow
import eu.europa.ec.eudi.trustvalidator.domain.KeyStoreConfig
import eu.europa.ec.eudi.trustvalidator.domain.ServiceType
import eu.europa.ec.eudi.trustvalidator.domain.TrustSourceConfig
import eu.europa.ec.eudi.trustvalidator.domain.TrustedListConfig
import eu.europa.ec.eudi.trustvalidator.domain.ValidatorConfig
import eu.europa.ec.eudi.trustvalidator.port.out.lotl.FetchLOTLCertificates
...
class RefreshTrustSources(
    ...
    private suspend fun updateLotl(regex: ServiceType, trustSourceConfig: TrustSourceConfig) {
